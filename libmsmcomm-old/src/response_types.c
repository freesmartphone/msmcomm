...
DEFINE_RESPONSE_TYPE(gsdi_callback)
DEFINE_RESPONSE_TYPE(sound)
DEFINE_RESPONSE_TYPE(cm_call_callback)
...
DEFINE_EVENT_TYPE(pdsm_pd_done)
DEFINE_EVENT_TYPE(pdsm_xtra)

DEFINE_EVENT_TYPE_WITHOUT_EXPLICIT_TYPE(cm_call)
...
struct descriptor response_descriptors[] = 
{
    ...
    REGISTER_RESPONSE_TYPE(MSMCOMM_MESSAGE_TYPE_RESPONSE_GSDI_CALLBACK, gsdi_callback, 0),
    REGISTER_RESPONSE_TYPE(MSMCOMM_MESSAGE_TYPE_RESPONSE_SOUND, sound, 0),
    REGISTER_RESPONSE_TYPE(MSMCOMM_MESSAGE_TYPE_RESPONSE_CM_CALL_CALLBACK, cm_call_callback, 0),
    ...
    REGISTER_EVENT_TYPE(MSMCOMM_MESSAGE_TYPE_EVENT_PDSM_PD_DONE, pdsm_pd_done, 0),
    REGISTER_EVENT_TYPE(MSMCOMM_MESSAGE_TYPE_EVENT_PDSM_XTRA, pdsm_xtra, 0),

    REGISTER_EVENT_TYPE_WITHOUT_EXPLICIT_TYPE(cm_call, 0),
