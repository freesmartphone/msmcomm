...
unsigned int event_sups_status_is_valid(struct msmcomm_message *msg)
{
    return (msg->group_id == 0xb);
}

void event_sups_status_handle_data(struct msmcomm_message *msg, uint8_t * data, uint32_t len)
{
}

void event_sups_status_free(struct msmcomm_message *msg)
{
}
