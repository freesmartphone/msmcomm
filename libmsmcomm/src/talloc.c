...
static struct talloc_chunk *talloc_alloc_pool(struct talloc_chunk *parent, size_t size)
{
    ...
    space_left = ((char *)pool_ctx + TC_HDR_SIZE + pool_ctx->size) - ((char *)pool_ctx->pool);
...
static inline void *__talloc(const void *context, size_t size)
{
    ...
    if (context != NULL)
    {
        tc = talloc_alloc_pool(talloc_chunk_from_ptr(context), TC_HDR_SIZE + size);
    }
...
static inline int _talloc_free(void *ptr)
{
    ...
    if (tc->flags & (TALLOC_FLAG_POOL | TALLOC_FLAG_POOLMEM))
    {
        ...
        pool = (tc->flags & TALLOC_FLAG_POOL) ? tc : (struct talloc_chunk *)tc->pool;
...
void talloc_free_children(void *ptr)
{
    ...
    if ((tc->flags & TALLOC_FLAG_POOL) && (*talloc_pool_objectcount(tc) == 1))
    {
...
void *_talloc_realloc(const void *context, void *ptr, size_t size, const char *name)
{
    ...
    if (tc->flags & TALLOC_FLAG_POOLMEM)
    {
        ...
        *talloc_pool_objectcount((struct talloc_chunk *)(tc->pool)) -= 1;
...
void talloc_report_depth_cb(const void *ptr, int depth, int max_depth,
                            void (*callback) (const void *ptr,
                                              ...
                                              int is_ref, void *private_data), void *private_data)
{
    struct talloc_chunk *c, *tc;
...
static void talloc_report_depth_FILE_helper(const void *ptr, int depth, int max_depth, int is_ref,
                                            void *_f)
{
    ...
    fprintf(f, "%*s%-30s contains %6lu bytes in %3lu blocks (ref %d) %p\n",
            ...
            (unsigned long)talloc_total_blocks(ptr), (int)talloc_reference_count(ptr), ptr);
