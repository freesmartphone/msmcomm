...
struct descriptor msg_descriptors[] = {
    ...
    MESSAGE_DATA(MSMCOMM_COMMAND_TEST_ALIVE, test_alive),
    MESSAGE_DATA(MSMCOMM_COMMAND_GET_IMEI, get_imei),
    MESSAGE_DATA(MSMCOMM_COMMAND_GET_FIRMWARE_INFO, get_firmware_info),
    MESSAGE_DATA(MSMCOMM_COMMAND_GET_PHONE_STATE_INFO, get_phone_state_info),
    MESSAGE_DATA(MSMCOMM_COMMAND_VERIFY_PIN, verify_pin),
    MESSAGE_DATA(MSMCOMM_COMMAND_GET_LOCATION_PRIV_PREF, get_location_priv_pref),
    MESSAGE_DATA(MSMCOMM_COMMAND_ANSWER_CALL, answer_call),
    MESSAGE_DATA(MSMCOMM_COMMAND_SET_AUDIO_PROFILE, set_audio_profile),
    MESSAGE_DATA(MSMCOMM_COMMAND_END_CALL, end_call),
    MESSAGE_DATA(MSMCOMM_COMMAND_DIAL_CALL, dial_call),
    MESSAGE_DATA(MSMCOMM_COMMAND_GET_CHARGER_STATUS, get_charger_status),
    MESSAGE_DATA(MSMCOMM_COMMAND_CHARGING, charging),
    MESSAGE_DATA(MSMCOMM_COMMAND_SET_SYSTEM_TIME, set_system_time),
    MESSAGE_DATA(MSMCOMM_COMMAND_RSSI_STATUS, rssi_status),
    MESSAGE_DATA(MSMCOMM_COMMAND_READ_PHONEBOOK, read_phonebook),
    MESSAGE_DATA(MSMCOMM_COMMAND_GET_NETWORKLIST, get_networklist),
    MESSAGE_DATA(MSMCOMM_COMMAND_SET_MODE_PREFERENCE, set_mode_preference),
    MESSAGE_DATA(MSMCOMM_COMMAND_GET_PHONEBOOK_PROPERTIES, get_phonebook_properties),
