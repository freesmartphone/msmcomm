...
namespace Msmcomm.PalmPre
{
    ...
    public abstract class Client : BaseClient
    {
        ...
        protected Client(BaseRadioAccess radio_access)
        {
            base(radio_access);
            setup_message_groups();
            radio_access.incoming_data.connect(handle_incoming_data);
        }

        public async bool enqueue_async( owned PalmPre.BaseMessage command,
